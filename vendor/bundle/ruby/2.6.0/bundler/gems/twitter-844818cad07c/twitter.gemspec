...
Gem::Specification.new do |s|
  ...
  s.files = [".yardopts".freeze, "CHANGELOG.md".freeze, "CONTRIBUTING.md".freeze, "LICENSE.md".freeze, "README.md".freeze, "lib/twitter.rb".freeze, "lib/twitter/arguments.rb".freeze, "lib/twitter/base.rb".freeze, "lib/twitter/basic_user.rb".freeze, "lib/twitter/client.rb".freeze, "lib/twitter/configuration.rb".freeze, "lib/twitter/creatable.rb".freeze, "lib/twitter/cursor.rb".freeze, "lib/twitter/direct_message.rb".freeze, "lib/twitter/direct_message_event.rb".freeze, "lib/twitter/entities.rb".freeze, "lib/twitter/entity.rb".freeze, "lib/twitter/entity/hashtag.rb".freeze, "lib/twitter/entity/symbol.rb".freeze, "lib/twitter/entity/uri.rb".freeze, "lib/twitter/entity/user_mention.rb".freeze, "lib/twitter/enumerable.rb".freeze, "lib/twitter/error.rb".freeze, "lib/twitter/factory.rb".freeze, "lib/twitter/geo.rb".freeze, "lib/twitter/geo/point.rb".freeze, "lib/twitter/geo/polygon.rb".freeze, "lib/twitter/geo_factory.rb".freeze, "lib/twitter/geo_results.rb".freeze, "lib/twitter/headers.rb".freeze, "lib/twitter/identity.rb".freeze, "lib/twitter/language.rb".freeze, "lib/twitter/list.rb".freeze, "lib/twitter/media/animated_gif.rb".freeze, "lib/twitter/media/photo.rb".freeze, "lib/twitter/media/video.rb".freeze, "lib/twitter/media/video_info.rb".freeze, "lib/twitter/media_factory.rb".freeze, "lib/twitter/metadata.rb".freeze, "lib/twitter/null_object.rb".freeze, "lib/twitter/oembed.rb".freeze, "lib/twitter/place.rb".freeze, "lib/twitter/profile.rb".freeze, "lib/twitter/profile_banner.rb".freeze, "lib/twitter/rate_limit.rb".freeze, "lib/twitter/relationship.rb".freeze, "lib/twitter/rest/api.rb".freeze, "lib/twitter/rest/client.rb".freeze, "lib/twitter/rest/direct_messages.rb".freeze, "lib/twitter/rest/favorites.rb".freeze, "lib/twitter/rest/friends_and_followers.rb".freeze, "lib/twitter/rest/help.rb".freeze, "lib/twitter/rest/lists.rb".freeze, "lib/twitter/rest/oauth.rb".freeze, "lib/twitter/rest/places_and_geo.rb".freeze, "lib/twitter/rest/request.rb".freeze, "lib/twitter/rest/saved_searches.rb".freeze, "lib/twitter/rest/search.rb".freeze, "lib/twitter/rest/spam_reporting.rb".freeze, "lib/twitter/rest/suggested_users.rb".freeze, "lib/twitter/rest/timelines.rb".freeze, "lib/twitter/rest/trends.rb".freeze, "lib/twitter/rest/tweets.rb".freeze, "lib/twitter/rest/undocumented.rb".freeze, "lib/twitter/rest/upload_utils.rb".freeze, "lib/twitter/rest/users.rb".freeze, "lib/twitter/rest/utils.rb".freeze, "lib/twitter/saved_search.rb".freeze, "lib/twitter/search_results.rb".freeze, "lib/twitter/settings.rb".freeze, "lib/twitter/size.rb".freeze, "lib/twitter/source_user.rb".freeze, "lib/twitter/streaming/client.rb".freeze, "lib/twitter/streaming/connection.rb".freeze, "lib/twitter/streaming/deleted_tweet.rb".freeze, "lib/twitter/streaming/event.rb".freeze, "lib/twitter/streaming/friend_list.rb".freeze, "lib/twitter/streaming/message_parser.rb".freeze, "lib/twitter/streaming/response.rb".freeze, "lib/twitter/streaming/stall_warning.rb".freeze, "lib/twitter/suggestion.rb".freeze, "lib/twitter/target_user.rb".freeze, "lib/twitter/trend.rb".freeze, "lib/twitter/trend_results.rb".freeze, "lib/twitter/tweet.rb".freeze, "lib/twitter/user.rb".freeze, "lib/twitter/utils.rb".freeze, "lib/twitter/variant.rb".freeze, "lib/twitter/version.rb".freeze, "twitter.gemspec".freeze]
